...
class ConnectionManager:
    ...
    async def send_notification(
        self, user_id: int, title: str, message: str, payload: dict = None
    ):
        import uuid
    ...
    async def save_chat_message(
        self, sender_id: int, receiver_id: int, text: str, timestamp: str = None
    ):
        import uuid
        from datetime import datetime
        ...
        try:
            ...
            for msg_str in messages:
                try:
                    ...
                    if (
                        user_id == 1
                        or msg.get("sender_id") == user_id
                        or msg.get("receiver_id") == user_id
                    ):
                        msg_payload = {"type": "chat_message", **msg}
